...
class OutputService:
    ...
    def clear_screen(self):
        ...
        raylibpy.clear_background(raylibpy.DARKGREEN)
        raylibpy.draw_rectangle(160, 0, 240, constants.MAX_Y, raylibpy.GRAY)

        raylibpy.draw_rectangle(460, 0, 240, constants.MAX_Y, raylibpy.GRAY)
